//
//  LifeStyleSeventhProductView.swift
//  Share Beauty App
//
//  Created by asiaquest on 2017/08/09.
//  Copyright © 2017年 AQUA Co., Ltd. All rights reserved.
//

import UIKit

protocol LifeStyleSeventhProductViewDelegate: NSObjectProtocol {
    func didTapProduct(_ product: ProductData?, transitionItemId: String?)
}

class LifeStyleSeventhProductView: BaseView {
    
    weak var delegate: LifeStyleSeventhProductViewDelegate?
...
// MARK: - UI Events
fileprivate extension LifeStyleSeventhProductView {
