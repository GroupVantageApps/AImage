//
//  LifeStyleFifthProductView.swift
//  Share Beauty App
//
...
protocol LifeStyleFifthProductViewDelegate: NSObjectProtocol {
    func didTapProduct(_ product: ProductData?, transitionItemId: String?)
}

class LifeStyleFifthProductView: BaseView {
    
    weak var delegate: LifeStyleFifthProductViewDelegate?
...
// MARK: - UI Events
fileprivate extension LifeStyleFifthProductView {
