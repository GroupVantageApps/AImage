//
//  LifeStyleFirstProductView.swift
//  Share Beauty App
//
//  Created by 久保島 祐磨 on 2017/06/12.
//  Copyright © 2017年 AQUA Co., Ltd. All rights reserved.
//

import UIKit

protocol LifeStyleFirstProductViewDelegate: NSObjectProtocol {
	func didTapProduct(_ product: ProductData?, transitionItemId: String?)
}

class LifeStyleFirstProductView: BaseView {
	
	weak var delegate: LifeStyleFirstProductViewDelegate?

	@IBOutlet weak var mBackImageView: UIImageView!
	@IBOutlet weak var mContentsView: UIView!
	
	@IBOutlet weak var mHeaderLabel: UILabel!
	@IBOutlet weak var mExplainLabel: UILabel!
	...
	var explainText: String? {
		get { return self.mExplainLabel.text }
		set { self.mExplainLabel.text = newValue }
	}
...
// MARK: - UI Events
fileprivate extension LifeStyleFirstProductView {
