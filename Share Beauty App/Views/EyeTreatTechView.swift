...
class EyeTreatTechView:UIView{
    ...
    titleLabel.frame = CGRect(x: 20 , y: 20+(300*i), width: 600, height: 30)
    ...
    titleDescription.frame = CGRect(x: 150, y: 60+(300*i), width: 500, height: 100)
    ...
    utmLine.frame = CGRect(x: 135, y: 85+(300*i), width: 1, height: 50)
    ...
    let title = UILabel()
    title.frame = CGRect(x:  300 - 120, y: 165+(300*i), width: 200, height: 27)
    ...
    title.frame = CGRect(x: 300 - 120, y: 150+(300*0)+(70*(i-1)), width: 400, height: 100)
    description.textColor = UIColor.black
    description.font = UIFont(name: "Reader-regular", size: 16)
    description.numberOfLines = 0
    description.sizeToFit()
    description.textAlignment = .left
    description.frame = CGRect(x: 300 - 120, y: 185+(300*0)+(70*(i-1)), width: 340, height: 100)
    
    
    if i == 1{
    title.text = AppItemTable.getNameByItemId(itemId: 8204)//"Skin Shield (Smoothing Oil"
    title.frame = CGRect(x: 300 - 120, y: 165+(300*0)+(70*(i-1)), width: 400, height: 100)
    ...
    description.frame = CGRect(x: 300 - 120, y: 175+(300*0)+(70*(i-1)), width: 340, height: 100)
    }else if i == 3{
    ...
    playerLayer.frame =  CGRect(x: 300 - 250, y: (300*i)-300, width: 950, height: 1000)
    ...
    let description = UILabel()
    description.frame = CGRect(x: 20 , y: 40+(300*i), width: 600, height: 30)
    description.text = AppItemTable.getNameByItemId(itemId: 8211)// "(Marjoram Extract, Dynamite Glycerin)"
    description.font = UIFont(name: "Reader-regular", size: 16)
    description.textColor = UIColor.black
    
    let titleDescription = UILabel()
    titleDescription.frame = CGRect(x: 150, y: 80+(300*i), width: 630, height: 100)
    //    titleDescription.centerX = self.mVContentLeft.centerX
    ...
    let line:UIImage = UIImage(named:"utm_line.png")!
    let utmLine = UIImageView(image:line)
    utmLine.frame = CGRect(x: 135, y: 100+(300*i), width: 1, height: 60)
    utmLine.contentMode = .scaleToFill
    generateV.addSubview(utmLine)
    ...
    graphImage.frame = CGRect(x: 0, y: 200+(300*i), width: 450, height: 270)
    ...
    arrowImage.frame = CGRect(x: 250, y: 220+(300*i), width: 25, height: 30)
    arrowImage.contentMode = .scaleToFill
    generateV.addSubview(arrowImage)
    
    let high = UILabel()
    high.frame = CGRect(x: 245 , y: 250+(300*i), width: 40, height: 30)
    ...
    graphDescription.frame = CGRect(x: 300, y: 220+(300*i), width: 170, height: 50)
    //    titleDescription.centerX = self.mVContentLeft.centerX
    ...
    let control = UILabel()
    control.frame = CGRect(x: 380, y: 460+(300*i), width: 170, height: 50)
    //    titleDescription.centerX = self.mVContentLeft.centerX
    ...
    let with = UILabel()
    with.frame = CGRect(x: 500, y: 465+(300*i), width: 150, height: 50)
    //    titleDescription.centerX = self.mVContentLeft.centerX
