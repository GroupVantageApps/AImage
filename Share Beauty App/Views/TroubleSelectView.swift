...
protocol TroubleSelectViewDelegate: ProductDetailTagDelegate {
}

class TroubleSelectView: BaseView, ProductDetailTagDelegate {
    ...
    weak var delegate: TroubleSelectViewDelegate?
    fileprivate func makeProductDetailTags() {
        if mVTagBase.subviews.count != 0 {
            return
        }
        var productDetailTags: [ProductDetailTag] = []
        var i = 0
        ...
        for trouble in troubles {
            ...
            let productDetailTag = ProductDetailTag()
