     ...
     //   mScrollV.isPagingEnabled = true
      //  mScrollV.delegate = self
        ...
        if productId == 618 {
            ...
            title.centerX = 100
            //self.centerX            title.textAlignment = .center
            ...
            for i in 1...3{
                ...
                percentLabel.frame = CGRect(x: Int(selfLeft.centerX) - 200, y: 110 + Int(self.efficacyScrollV.frame.height)*1+(130*(i-1)), width: 160, height: 82)
                percentLabel.textAlignment = .center
                self.efficacyScrollV.addSubview(percentLabel)
            }
            ...
            for i in 1...3{
                ...
                description.numberOfLines = 0
                description.textAlignment = .left
                description.frame = CGRect(x: Int(selfLeft.centerX) - 20, y: 70 + Int(self.efficacyScrollV.frame.height)*1+(130*(i-1)), width: 235, height: 150)
            ...
            title3.centerX = selfRight.centerX
            ...
            for i in 1...3{
                ...
                percentLabel.frame = CGRect(x: Int(selfRight.centerX) - 200, y: 110 + Int(self.efficacyScrollV.frame.height)*1+(130*(i-1)), width: 160, height: 82)
                percentLabel.textAlignment = .center
                self.efficacyScrollV.addSubview(percentLabel)
            }
            ...
            for i in 1...3{
                ...
                description.numberOfLines = 0
                description.textAlignment = .left
                description.frame = CGRect(x: Int(selfRight.centerX) - 20, y: 70 + Int(self.efficacyScrollV.frame.height)*1+(130*(i-1)), width: 235, height: 150)
            ...
            for i in 1...6{
                ...
                percentLabel.frame = CGRect(x: Int(selfLeft.centerX) - 200, y: 20 + Int(self.efficacyScrollV.frame.height)*2+(75*(i-1)), width: 160, height: 42)
                percentLabel.textAlignment = .center
                self.efficacyScrollV.addSubview(percentLabel)
                
                percentLabel2.frame = CGRect(x: Int(selfLeft.centerX) - 205, y: 50 + Int(self.efficacyScrollV.frame.height)*2+(75*(i-1)), width: 160, height: 42)
                percentLabel2.textAlignment = .center
                self.efficacyScrollV.addSubview(percentLabel2)
                
                description.frame = CGRect(x: Int(selfRight.centerX) - 256, y: 30 + Int(self.efficacyScrollV.frame.height)*2+(75*(i-1)), width: 500, height: 42)
                self.efficacyScrollV.addSubview(description)
            }
    ...
    func setEffency19AW(productId: Int){
        ...
        if productId == 618 {
            for i in 0...1 {
                ...
                title.frame = CGRect(x: 0, y: 0+(Int(self.efficacyScrollV.frame.height)*i), width: 700, height: 40)
                title.centerX = mVContent.centerX
                title.textAlignment = .center
                self.efficacyScrollV.addSubview(title)
            }
            ...
            for i in 1...7{
                ...
                if i == 1 {
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8167)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 100+(100*(i-1)), width: 160, height: 82)
                } else if i == 2 {
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8169)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 100+(100*(i-1)), width: 160, height: 82)
                } else if i == 3{
                    ...
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8175)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 80+(Int(self.efficacyScrollV.frame.height))+(100*(i-4)), width: 160, height: 82)
                } else if i == 5 {
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8177)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 80+(Int(self.efficacyScrollV.frame.height))+(100*(i-4)), width: 160, height: 82)
                } else if i == 6 {
            ...
            for i in 1...7{
                ...
                if i == 1 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8168) // "of women felt it was deeply \n hydrating"
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 60+(100*(i-1)), width: 300, height: 150)
                } else if i == 2 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8170) // "of women felt their skin \n absorbed it quickly"
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 60+(100*(i-1)), width: 300, height: 150)
                } else if i == 3 {
                    ...
                    description.text = AppItemTable.getNameByItemId(itemId: 8176) // "of women felt their skin became \n more resilient."
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 40+(Int(self.efficacyScrollV.frame.height))+(100*(i-4)), width: 300, height: 150)
                } else if i == 5 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8178) // "of women felt their skin became \n brighter and the clarity improved."
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 40+(Int(self.efficacyScrollV.frame.height))+(100*(i-4)), width: 350, height: 150)
                } else if i == 6 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8180) // "of women felt it increased their skin's moisture after application."
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 40+(Int(self.efficacyScrollV.frame.height))+(100*(i-4)), width: 350, height: 150)
                } else {
            ...
            for i in 1...2{
                ...
                if i == 1 {
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8193)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 80+(Int(self.efficacyScrollV.frame.height))+(30*i), width: 160, height: 82)
                } else if i == 2 {
                    percentLabel.text = AppItemTable.getNameByItemId(itemId: 8197)
                    percentLabel.frame = CGRect(x: Int(mVContent.centerX) - 230, y: 80+(Int(self.efficacyScrollV.frame.height))+250, width: 160, height: 82)
                }
                percentLabel.textAlignment = .center
            ...
            for i in 1...2{
                ...
                if i == 1 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8194) // "of women felt it created \n a rich lather that lasted on their skin"
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 70+(Int(self.efficacyScrollV.frame.height)), width: 250, height: 150)
                } else if i == 2 {
                    description.text = AppItemTable.getNameByItemId(itemId: 8198) // "of women felt it \n softed their skin"
                    description.frame = CGRect(x: Int(mVContent.centerX) - 50, y: 290+(Int(self.efficacyScrollV.frame.height)), width: 200, height: 150)
                }
            ...
            for i in 1...2{
                ...
                self.efficacyScrollV.addSubview(graphV)
            }
            ...
            for i in 1...3{
                ...
                self.efficacyScrollV.addSubview(graphLabel)
            }
            self.efficacyScrollV.addSubview(generateV)
            ...
            faceImageV_after.clipsToBounds = true
            faceImageV_after.frame = CGRect(x: 0, y: 70+(Int(self.efficacyScrollV.frame.height)*0), width: 300, height: 300)
            faceImageV_after.centerX = mVContent.centerX
            faceImageV_after.backgroundColor = UIColor.clear
            ...
            faceImageV.clipsToBounds = true
            faceImageV.frame = CGRect(x: 0, y: 70+(Int(self.efficacyScrollV.frame.height)*0), width: 300, height: 300)
            faceImageV.centerX = mVContent.centerX
            faceImageV.backgroundColor = UIColor.clear
            
            let beforeBtn = UIButton()
            beforeBtn.isEnabled = false
            beforeBtn.frame = CGRect(x: 0, y: 400+(Int(self.efficacyScrollV.frame.height)*0), width: 145, height: 30)
            beforeBtn.origin.x = mVContent.centerX - beforeBtn.frame.width - 10
            beforeBtn.setTitle(AppItemTable.getNameByItemId(itemId: 8238), for: .normal) // "Before"
            beforeBtn.isEnabled = false
            beforeBtn.setTitleColor(UIColor.white, for: .normal)
            beforeBtn.backgroundColor = UIColor(red: 185.0/255.0, green: 0.0/255.0, blue: 35.0/255.0, alpha: 1.0)
...
//            beforeBtn.addTarget(self, action: #selector(self.onTapBeforeAfterBtn(_:)), for: .touchUpInside)
            ...
            afterBtn.isEnabled = true
            afterBtn.frame = CGRect(x: 0, y: 400+(Int(self.efficacyScrollV.frame.height)*0), width: 145, height: 30)
            afterBtn.origin.x = mVContent.centerX + 10
            afterBtn.setTitle(AppItemTable.getNameByItemId(itemId: 8239), for: .normal) // "After 4 Weeks"
            afterBtn.isEnabled = true
            afterBtn.setTitleColor(UIColor.white, for: .normal)
            afterBtn.backgroundColor = UIColor(red: 185.0/255.0, green: 0.0/255.0, blue: 35.0/255.0, alpha: 1.0)
...
//            afterBtn.addTarget(self, action: #selector(self.onTapBeforeAfterBtn(_:)), for: .touchUpInside)
            ...
            for j in 0...2{
                ...
                if j == 0{
                    border.frame = CGRect(x: Int(mVContent.centerX) - Int(beforeBtn.frame.width) - 20, y: 398+(Int(self.efficacyScrollV.frame.height)*0), width: 1, height: 34)
                }else if j == 1{
                    border.frame = CGRect(x: Int(mVContent.centerX), y: 398+(Int(self.efficacyScrollV.frame.height)*0), width: 1, height: 34)
                    
                }else if j == 2{
                    border.frame = CGRect(x: Int(mVContent.centerX) + Int(afterBtn.frame.width) + 20, y: 398+(Int(self.efficacyScrollV.frame.height)*0), width: 1, height: 34)
