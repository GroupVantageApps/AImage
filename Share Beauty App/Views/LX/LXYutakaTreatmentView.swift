...
class LXYutakaTreatmentView: UIView, UIScrollViewDelegate, LXYutakaTreatmentContentFirstViewDelegate {
    ...
    var titleArray = ["Essential Treatment","Ultimate Brightening","Ultimate Brightening with Hand Treatment","Ultimate Moisture Firming","Ultimate Moisture Firming with Hand Treatment","Brightening Express","Essential Express","Moisture Firming Express"]
