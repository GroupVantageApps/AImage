    ...
    static var target: Target {
        get {
            if let value = UserDefaultKey.target.get() {
                ...
                return develop.release //DB向き 本番
                
                // UserDefaultKey.target.set(value: Target.develop.rawValue)//DB向き　develop or relese 無理やり
               // return Target.develop //DB向き　develop or relese 無理やり
            }
        }
        set (value) {
