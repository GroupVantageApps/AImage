...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        print("LanguageId: " + LanguageConfigure.languageId.description)
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        if Utility.checkOnline() && DownloadConfigure.downloadStatus == .success {
            LogManager.sendLog()
            LogManager.sendProductLog{ status in }
        }
    }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        LifeStyleBeautyCount.clearLocalData()
...
/*
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "jp.co.aqua-web.Share_Beauty_App" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Share_Beauty_App", withExtension: "momd")!
