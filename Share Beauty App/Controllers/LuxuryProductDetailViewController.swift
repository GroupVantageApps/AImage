...
class LuxuryProductDetailViewController: LXBaseViewController, LXNavigationViewDelegte, LXHeaderViewDelegate, LXCategoryButtonDelegate, UtmFeaturesViewDelegate, TroubleViewDelegate, LXTroubleSelectViewDelegate, LXIngredientViewDelegate, MoviePlayerViewDelegate , UIScrollViewDelegate ,IngredientSkinGraphViewDelegate{
