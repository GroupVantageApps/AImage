//
//  LifeStyleSixthDetailViewController.swift
//  Share Beauty App
//
...
class LifeStyleSixthDetailViewController: UIViewController, NavigationControllerAnnotation, LifeStyleSixthProductViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let imageId = AppItemTranslateTable.getEntity(7923).mainImage.first
        self.mTopImageView.image = FileTable.getImage(imageId)
    }
    
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        let productList = ProductListData(screenId: Const.screenIdLifeStyleBeautyG)
        items = AppItemTable.getItems(screenId: Const.screenIdLifeStyleBeautyG)
