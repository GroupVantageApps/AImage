//
//  LifeStyleEighthDetailViewController.swift
//  Share Beauty App
//
...
class LifeStyleEighthDetailViewController: UIViewController, NavigationControllerAnnotation, LifeStyleEighthProductViewDelegate, UIScrollViewDelegate {
    @IBOutlet private var mLifeStyleProductViews: [LifeStyleEighthProductView]!
    ...
    private let mScreen = ScreenData(screenId: Const.screenIdLifeStyleBeautyI)
    ...
    override func viewDidLoad() {
        ...
        let imageId = AppItemTranslateTable.getEntity(7925).mainImage.first
