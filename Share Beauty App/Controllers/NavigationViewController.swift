...
class NavigationViewController: UIViewController, NavigationControllerDelegate, HeaderViewDelegate, NavigationViewDelegte, SideBarDelegate {
    ...
    private static let outAppInfos = [Const.outAppInfoUTMMask, Const.outAppInfoFoundation, Const.outAppInfoESSENTIAL, Const.outAppInfoNavigator, Const.outAppInfoUltimune, Const.outAppInfoUvInfo, Const.outAppInfoSoftener]
...
//        mHeaderView.setOutAppEnabled(!LanguageConfigure.isOutAppBtnHiddenCountry)
    ...
    private func updateData() {
        //Update Tap時に無理やりdevelopを向かせる 無理やり　develop or relese
