...
class ProductListViewController: UIViewController, NavigationControllerAnnotation, RecommendProductViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    internal func didSelect(product: ProductData) {
        ...
        productDetailVc.relationProducts = products
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.row % 2 == 0 {
            ...
            cell.delegate = self
            cell.product = products[indexPath.row / 2]
            return cell
        } else {
